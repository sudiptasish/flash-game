...
<%
	String errorMsg = request.getAttribute("error.msg") != null ? (String)request.getAttribute("error.msg") : "";
%>
<html>
	<head>
		<title>Contact</title>
				...
				<td>						
					...
					<table width="900" border="0" align="center" cellpadding="0" cellspacing="0" class="mainbg">
						...
						<tr>
							...
							<td align="right" width="550" height="30" style="padding-right:35px;color:#CC0000">&nbsp;</td>
						</tr>
							...
							<td colspan="2" align="center">
								<table border="0" align="center" cellpadding="0" cellspacing="0">
									<tr>
										...
										<td width="122" align="center" class="titbg_gray white t13 bold">Error Page</td>
